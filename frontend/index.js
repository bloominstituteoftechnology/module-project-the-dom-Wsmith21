...
const mumboJumbo = `We need to${randomAdverb1} our ${randomNoun1} ${randomVerb1} in order to ${randomAdverb2} our ${randomNoun2} ${randomAdverb2}.`
...
setInterval(() => {
  ...
  if (!person.friends.length) {
    ...
    for (let idx = 0; idx < person.friends.length; idx++) {
      const friendsId = person.friends[idx]
